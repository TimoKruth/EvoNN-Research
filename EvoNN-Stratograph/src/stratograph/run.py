...
def run_engine(
    ...
    *,
    ...
    if resume is None:
        ...
        for definition in definitions:
            ...
            prepared = _process(
                ...
                worker_module=search_type.worker_module,
            )
    ...
    with boundary_ownership(workspace.root):
        ...
        exported = export_run(workspace, state, definitions, pack, selection, device_class, inherited, artifact_builder=build_artifacts)
        clock.finish()
        return exported
