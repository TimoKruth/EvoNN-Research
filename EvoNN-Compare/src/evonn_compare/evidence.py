...
def protocol_fingerprint(bundle):
    ...
    if bundle.manifest.system.value in {"prism", "topograph", "stratograph", "primordia"}:
        ...
        keys = ("source_sha256", "epochs", "population_size", "fit_timeout", "benchmark_pooling", "novelty_weight", "variant", "evaluator_fidelity", "research", "inheritance_policy", "optimizer_policy", "optimizer_backend", "fixed_genomes", "prior_discovery")
